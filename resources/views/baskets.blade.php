<x-x-header />
    ...
    <div class="container d-flex justify-content-around" style="margin-top: 30px; margin-bottom:40px;">
            ...
            <table class="table table-borderless table_product">
                ...
                <tbody>
                    ...
                    <tr class="product_basket_one">
                        ...
                        <td style="vertical-align: middle; text-align: center; padding-top:20px;" class="d-flex align-item-center">
                
                         <a href="/{{$item->id}}/baskets_delete" class="product_delete"></a> 
                         </td>
                    </tr>
                    @empty
                    <tr>
        ...
        <div class="d-flex flex-column order_product ">
            ...
            <p class="d-flex  justify-content-center">В корзине <span id="total_count" style="margin:0px 5px; font-size: 20px;"></span> товара<span id="sum"  style="margin-left: 30px;">
